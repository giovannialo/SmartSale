...
DROP TABLE IF EXISTS `" + database + "`.`supplier`;
...
DROP TABLE IF EXISTS `" + database + "`.`measure_type`;
CREATE TABLE IF NOT EXISTS `" + database + "`.`measure_type`
(
    `id`              INT         NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `" + database + "`.`product_has_supplier`;
CREATE TABLE IF NOT EXISTS `" + database + "`.`product_has_supplier`
(
...
DROP TABLE IF EXISTS `" + database + "`.`customer`;
...
DROP TABLE IF EXISTS `" + database + "`.`sale`;
...
DROP TABLE IF EXISTS `" + database + "`.`sale_item`;
CREATE TABLE IF NOT EXISTS `" + database + "`.`sale_item`
(
